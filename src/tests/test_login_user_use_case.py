...
class TestLoginUserUseCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.pwdHasher_mock = Mock()
        self.usecase = LoginUserUseCase(
            self.form_mock, self.repository_mock, self.pwdHasher_mock)
    ...
    def test_attempt_login_user_with_valid_credentials(self):
        ...
        self.repository_mock.get_user_password_by_username.return_value = "hashed_password"
        self.pwdHasher_mock.check_password.return_value = True
        ...
        self.repository_mock.get_user_by_username.assert_called_once_with(
            "username")
        ...
        self.repository_mock.get_user_password_by_username.assert_called_once_with(
            "username")
        self.pwdHasher_mock.check_password.assert_called_once_with(
    ...
    def test_attempt_login_user_not_registered_(self):
        ...
        self.repository_mock.exists_user_with_field.assert_called_once_with("username", "username")
