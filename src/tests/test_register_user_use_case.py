...
class TestRegisterUserUseCase(unittest.TestCase):
    ...
    def test_register_user(self):
        ...
        self.assertEqual(attempt_result, True, "User instance  data is already in the database.")
    ...
    def test_username_already_used(self):
        ...
        result_check_field_unique = use_case._RegisterUserUseCase__check_unique_fields(user)
        self.assertEqual(result_check_field_unique, "username", "Username was not being used")
    ...
    def test_email_already_used(self):
        ...
        result_check_unique_field = use_case._RegisterUserUseCase__check_unique_fields(user)
